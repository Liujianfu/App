...
using EvvMobile.Droid.Customizations.CustomControls;
using Xamarin.Forms;
...
namespace EvvMobile.Droid.Customizations.CustomControls
{
    /// <summary>
    ...
    public partial class ImageButtonRenderer : ButtonRenderer
    {
        ...
        private async Task SetImageSourceAsync(Android.Widget.Button targetButton, ImageButton model)
        {
            ...
            using (var bitmap =  GetBitmapAsync(source).Result)
            {            
