...
namespace EvvMobile.Droid.Charts
{
	...
	public class ChartRenderer : ViewRenderer<Chart, ChartSurface>
	{
		...
		protected override void OnElementChanged(ElementChangedEventArgs<Chart> e)
		{
			...
			ChartSurface surfaceView = new ChartSurface(Forms.Context, Element, Element.Color.ToAndroid(), colors,Element.BackGroundColor.ToAndroid());
		...
		protected override void OnElementPropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
		{
			...
			{
				Control.Paint = new Paint() { Color = Element.Color.ToAndroid(), StrokeWidth = 6 };
				Control.Invalidate();
			}
