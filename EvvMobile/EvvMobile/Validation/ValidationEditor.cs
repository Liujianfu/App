...
{
    public class ValidationEditor : Editor, IControlValidation
    {
        #region Property
        ...
        public static readonly BindableProperty HasErrorProperty =
            BindableProperty.Create("HasError", typeof(bool), typeof(ValidationEditor), false, defaultBindingMode: BindingMode.TwoWay);
        ...
        public static readonly BindableProperty ErrorMessageProperty =
            BindableProperty.Create("ErrorMessage", typeof(string), typeof(ValidationEditor), string.Empty);
        ...
        public static readonly BindableProperty ShowErrorMessageProperty =
            BindableProperty.Create("ShowErrorMessage", typeof(bool), typeof(ValidationEditor), false, propertyChanged: OnShowErrorMessageChanged, defaultBindingMode: BindingMode.TwoWay);

        private static void OnShowErrorMessageChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ValidationEditor control = bindable as ValidationEditor;
