...
{
    public class ValiationEntry : Entry, IControlValidation
    {
        #region Property
        ...
        public static readonly BindableProperty HasErrorProperty =
            BindableProperty.Create("HasError", typeof(bool), typeof(ValiationEntry), false, defaultBindingMode: BindingMode.TwoWay);
        ...
        public static readonly BindableProperty ErrorMessageProperty =
            BindableProperty.Create("ErrorMessage", typeof(string), typeof(ValiationEntry), string.Empty);
        ...
        public static readonly BindableProperty ShowErrorMessageProperty =
            BindableProperty.Create("ShowErrorMessage", typeof(bool), typeof(ValiationEntry), false, propertyChanged: OnShowErrorMessageChanged, defaultBindingMode: BindingMode.TwoWay);
        ...
        private static void OnShowErrorMessageChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            ValiationEntry control = bindable as ValiationEntry;
