...
namespace EvvMobile.Customizations.CustomControls.Calendar
{
	public partial class Calendar : ContentView
	{
		...
		double w, h;
	    public static readonly BindableProperty CalendarViewTypeProperty =
	        BindableProperty.Create(nameof(CalendarViewType), typeof(int), typeof(Calendar), 0,
	            propertyChanged: (bindable, oldValue, newValue) => (bindable as Calendar).CalendarViewType =( DateTypeEnum)newValue);
