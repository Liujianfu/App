...
namespace EvvMobile.Customizations.CustomControls.Calendar
{
	public partial class Calendar : ContentView
	{
		...
		protected void RightArrowClickedEvent(object s, EventArgs a)
		{
			...
			RightArrowClicked?.Invoke(s, new DateTimeEventArgs { DateTime = CalendarStartDate(StartDate), IsWeekView = CalendarViewType == DateTypeEnum.Week });
			RightArrowCommand?.Execute(CalendarStartDate(StartDate));
		}
		...
		protected void LeftArrowClickedEvent(object s, EventArgs a)
		{
			...
			LeftArrowClicked?.Invoke(s, new DateTimeEventArgs { DateTime = CalendarStartDate(StartDate), IsWeekView = CalendarViewType == DateTypeEnum.Week });
			LeftArrowCommand?.Execute(CalendarStartDate(StartDate));
		}
