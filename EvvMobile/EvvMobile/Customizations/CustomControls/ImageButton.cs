...
namespace EvvMobile.Customizations.CustomControls
{
    ...
    public class ImageButton : Button
    {
        ...
        /// </summary>
        public static readonly BindableProperty DisabledSourceProperty = BindableProperty.Create(nameof(DisabledSource), typeof(ImageSource), typeof(ImageButton),
            null,
            BindingMode.OneWay,
            null,
            (bindable, oldvalue, newvalue) => ((VisualElement)bindable).ToString());
        ...
        public static readonly BindableProperty ImageWidthRequestProperty =
            BindableProperty.Create(
                nameof(ImageWidthRequest), typeof(int), typeof(ImageButton),
                 default(int));
        ...
        public static readonly BindableProperty ImageHeightRequestProperty =
            BindableProperty.Create("ImageHeightRequest",typeof(int),typeof(ImageButton),default(int));
        ...
        public static BindableProperty PaddingProperty = BindableProperty.Create(nameof(Padding), typeof(Thickness), typeof(ImageButton), default(Thickness), defaultBindingMode: BindingMode.OneWay);
