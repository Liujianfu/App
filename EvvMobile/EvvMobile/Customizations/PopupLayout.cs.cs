...
namespace EvvMobile.Customizations
{
    ...
    public class PopupLayout : ContentView
    {
        ...
        private bool contentInputTransparent;
        /// <summary>
        ...
        public void ShowPopup(View popupView, Constraint xConstraint, Constraint yConstraint, Constraint widthConstraint = null, Constraint heightConstraint = null)
        {
            ...
            {
                contentInputTransparent = this.content.InputTransparent;
            }
            DismissPopup();
            this.popup = popupView;
            this.popup.BackgroundColor=Color.Transparent;
            if (this.content != null)
            {
        ...
        public void DismissPopup()
        {
            ...
            if (this.content != null)
            {
                this.content.InputTransparent = contentInputTransparent;
            }
        }
    }
}
