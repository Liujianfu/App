...
namespace EvvMobile.Pages.Base
{
    ...
    /// </summary>
    public abstract class ModelBoundWithHomeButtonTabbedPage<TViewModel> : TabbedPage where TViewModel : class, IBaseViewModel
    {
        public ModelBoundWithHomeButtonTabbedPage()
        {
